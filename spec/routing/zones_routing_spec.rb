...
describe ZonesController do
  describe "route generation" do
    ...
    it "should map #update" do
      route_for(:controller => "zones", :action => "update", :id => "1").should == {:path => "/zones/1", :method => :put }
    end

    it "should map #destroy" do
      route_for(:controller => "zones", :action => "destroy", :id => "1").should == {:path => "/zones/1", :method => :delete }
    end
  end
