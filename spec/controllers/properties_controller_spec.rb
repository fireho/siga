  ...
  describe "When Logged In" do
    ...
    describe "GET index" do
      ...
      it "exposes all properties as @properties" do
        Property.should_receive(:search).with(nil, nil).and_return([mock_property])
        get :index
      ...
      describe "with mime type of xml" do
        ...
        it "renders all properties as xml" do
          Property.should_receive(:search).with(nil, nil).and_return(properties = mock("Array of Properties"))
